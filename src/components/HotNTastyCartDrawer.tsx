...
export const HotNTastyCartDrawer: React.FC<HotNTastyCartDrawerProps> = ({
  ...
  const handleWhatsAppCheckout = () => {
    ...
    const message = `*HOT N TASTY - NEW ORDER*\n-------------------------\n*Name:* ${customerName.trim()}\n*Area:* ${selectedArea}\n*Address:* ${deliveryAddress.trim()}\n-------------------------\n*ITEMS ORDERED:*\n${itemsText}\n-------------------------\n*Total Bill:* Rs. ${subtotal}`;
  ...
  return (
    <>
      ...
      {/* Drawer */}
      <div
        className={`fixed top-0 right-0 h-full w-full sm:w-[460px] bg-[#121214] border-l border-zinc-800 shadow-2xl z-50 transform transition-transform duration-300 ease-out flex flex-col ${
          ...
          <div className="p-6 border-t border-zinc-800 bg-zinc-900/90 space-y-4 max-h-[65%] overflow-y-auto">
            ...
            <div className="space-y-3 border-b border-zinc-800 pb-4">
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full px-3 py-2 bg-zinc-950 border border-zinc-800 rounded-lg text-white text-xs focus:outline-none focus:border-red-500"
                />
              </div>
              ...
              <div className="space-y-1">
                ...
                <textarea
                  ...
                  rows={2}
                  className="w-full px-3 py-2 bg-zinc-950 border border-zinc-800 rounded-lg text-white text-xs focus:outline-none focus:border-red-500 resize-none"
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-between text-zinc-400 text-sm">
                ...
                <span className="text-emerald-500 font-bold">Calculated on call</span>
              </div>
